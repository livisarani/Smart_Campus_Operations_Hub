...
// Resource pages - Member 1
import UserResources from './pages/Resources/UserResources.jsx'
import AdminResources from './pages/Resources/AdminResources.jsx'
...
const SearchIcon = () => (
  <svg
    style={{ ...iconStyle, width: 14, height: 14, color: '#8a948d' }}
    viewBox="0 0 24 24"
  >
...
const ADMIN_NAV = [
  { to: '/admin/resources', label: 'Manage Resources', icon: RoomIcon },
  { to: '/admin/resources/create', label: 'Add Resource', icon: RoomIcon },
